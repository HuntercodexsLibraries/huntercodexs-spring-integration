...
@Service
@Configuration
@ConfigurationProperties(prefix = GLOBAL_BASE_CONFIG+".rabbitmq.consumers")
public class RabbitConsumersPropertiesIntegration {
    ...
    private List<RabbitConsumersPropertiesIntegration> consumers;
